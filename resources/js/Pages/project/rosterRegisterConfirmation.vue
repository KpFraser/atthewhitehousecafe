...
const submit = () => {
    ...
    let email = queryString.split('/')[4]
    let slug = queryString.split('/')[5]
    let name = queryString.split('/')[6]
    console.log(email, slug, name)
    axios
        ...
        <div class="flex justify-center items-center max-w-lg mx-auto font-serif">
            <div class="w-full mb-28 justify-center">
                <form @submit.prevent="submit" class="text-[22px] mx-10">
                    ...
                    <!--                        <BreezeCheckbox class="accent-[#639f1e] w-5 h-5 border-[#639f1e] text-[16px] hover:text-[#639f1e]"/>-->
