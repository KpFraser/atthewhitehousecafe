            ...
            <div class="w-full justify-center">
                ...
                <div class="text-black border-4 border-b-4 border-[#20351d] my-10 p-5 border-opacity-75 mb-28 space-y-4 bg-white text-lg">
                    ...
                    <div class="mx-10 py-2 px-6">
                        <h3 class="font-bold mb-2 cursor-pointer" v-for="data in 3" data-bs-toggle="modal" data-bs-target="#preview">Project Name</h3>
                    </div>
                    <div class="bg-white py-4 border-t-2 border-opacity-75 font-bold flex items-center justify-center border-[#639f1e] text-center">Empty!</div>
                </div>
            </div>
                            ...
                            <div v-for="data in 5">
                                <div class="my-2 font-sans mx-auto w-3/4">
                                    <div class="flex justify-between items-center pr-6 py-1.5 bg-[#639f1e] bg-opacity-75 text-black text-xs leading-tight rounded shadow-md font-bold transition duration-150 ease-in-out whitespace-nowrap">
                                        <span class="px-6 py-2 text-[16px] font-bold">Application 1 as leader</span>
                                        <span class="flex">
                                        <i class="fas border-2 cursor-pointer border-black flex justify-center items-center fa-plus fa-2x w-8 ml-3 h-8 bg-white rounded-full text-black py-1" data-bs-toggle="modal" data-bs-target="#ApplicationModal"></i>
